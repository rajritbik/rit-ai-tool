  ...
  return (
    <div className="grid grid-cols-5 h-screen text-center">
      ...
      <div className="col-span-4 p-10">
        ...
        <div
          ref={scrollToAns}
          className="container h-110 overflow-scroll no-scrollbar"
        >
        ...
        <div className="bg-zinc-700 w-1/2 p-1 text-white m-auto rounded-4xl border border-bs-zinc-700 flex h-16">
          <input
            type="text"
            value={question}
